...
export function FeedbackContentStep({
  ...
  return (
    ...
    <form action="" onSubmit={handleSubmitFeedback} className="my-4 w-full">
      ...
      focus:border-brand-500 focus:ring-1 focus:ring-brand-500 resize-none focus:outline-none scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
